...
```{r}
#| label: fig-leach_hist
#| fig-cap: "Histogram of leaching data (raw) illustrating the wide range of values and skew."
...
```{r}
#| label: fig-leach_biplot1_gg
#| fig-cap: "PCA of the complete dataset using ggplot2."
#| fig-width: 4
#| fig-height: 3.5
