...
*Q35. Copy down the binomial probability mass function (from Chapter* @sec-appendix*) and use it as an alternative method for calculating the fertility proportions for two eggs (a, b, c above).*
